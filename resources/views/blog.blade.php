<x-layout>
    ...
    <article class="py-8 max-w-screen-md border-b border-gray-900">
        ...
        <div class="text-base text-gray-500"><a href="">judul</a>tanggal</div>
        <p class="my-4 font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, eum.</p>
